...
- Daisy marks Libby follow-up/human-review escalation work `completed` once the human review request has been created/escalated, and the backend queue bridge mirrors related Daisy queue-item completions into PostgreSQL
