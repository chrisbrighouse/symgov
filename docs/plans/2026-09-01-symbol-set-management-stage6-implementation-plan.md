...
**Status:** IMPLEMENTATION IN PROGRESS — WP6.1 (`716c6bb`), WP6.2+WP6.3 (`9469f63`), and WP6.4 (`c9c6fc4`) are implemented, tested, and committed. WP6.5 (effective palette consumer surface) is implemented and tested locally, not yet committed. WP6.6 is planned but not started.
