...
**Status:** IMPLEMENTATION IN PROGRESS — WP6.1 (effective-palette read-model service and API) is implemented, tested, and committed (`716c6bb`). WP6.2 (Symbol Set Builder search) and WP6.3 (organization-wide toggle frontend surface) are implemented and tested locally, not yet committed. WP6.4–WP6.6 are planned but not started. All five open questions in §4 were resolved with Chris on 2026-09-01; §4 now records the decisions rather than open questions.
