...
**Status:** IMPLEMENTATION IN PROGRESS — WP6.1 (`716c6bb`) and WP6.2+WP6.3 (`9469f63`) are implemented, tested, and committed. WP6.4 (Symbol Set Builder frontend) is implemented and tested locally, not yet committed. WP6.5–WP6.6 are planned but not started. All five open questions in §4 were resolved with Chris on 2026-09-01; §4 now records the decisions rather than open questions.
