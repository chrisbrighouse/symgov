...
- Offline TDD contract suite: `10 passed`.
...
- Retention/deletion: an expired synthetic trace was ingested, confirmed visible, deleted via the public API, and polled until no longer returned. The Langfuse worker processes this asynchronously; the verifier allows 120 seconds.
